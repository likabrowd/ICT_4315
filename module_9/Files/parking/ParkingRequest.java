...
/**
 ...
 JSON wire format:
  ...
  This class replaces the old line-by-line protocol where the client sent:
    CUSTOMER\n
    firstname=Kalika\n
    phone=303-123-4567\n
    end\n
 
  The new JSON approach sends a single line of JSON, enabling compatibility with web tools (curl, Postman) and standard JSON APIs.
 */
...
public class ParkingRequest {
    ...
    /**
     Converts this ParkingRequest into a single-line JSON string suitable for transmission over a socket.
    ...
    /**
     Parses a JSON string into a ParkingRequest.
     
     Handles the format produced by {@link #toJson()}.
     Returns an empty request (no command, empty params) for null/blank input.
     
     @param json the JSON string to parse
     @return a ParkingRequest constructed from the JSON
     */
    ...
    //Extracts a top-level quoted string field value by key.
    ...
    //Extracts the nested "params" object as a Properties map.
